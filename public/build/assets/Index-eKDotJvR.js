import{q as I,r as h,j as e,$ as R,Y as k}from"./app-CcdzEu0R.js";import{y as F,D as r}from"./Footer-4Livvlxt.js";import{p as C,e as B}from"./index-BMkeTrLY.js";import{E as M}from"./ErpLayout-u_y7Ersr.js";import{d as E,f as s}from"./helpers-B9XmgPRl.js";import{C as u}from"./Card-CSAU_t4j.js";import{B as z}from"./ButtonGroup-CEgI5t_N.js";import{B as L}from"./Image-D_GvnDn_.js";import{T as U}from"./Table-D-OHgQ10.js";import"./CloseButton-Bv_xupVB.js";import"./Form-CLPTCCgE.js";import"./iconBase-CciruWzR.js";/* empty css                      */function at(){const{statusOptions:c,priorityOptions:m}=I().props,[n,b]=h.useState("all"),[o,x]=h.useState("all"),f=h.useCallback(()=>($.fn.DataTable.isDataTable("#repairOrdersTable")&&$("#repairOrdersTable").DataTable().destroy(),$("#repairOrdersTable").DataTable({processing:!0,serverSide:!0,ajax:{url:route("repair-orders.index"),type:"GET",data:function(a){a.status=n!=="all"?n:"",a.priority=o!=="all"?o:""},error:a=>{var d;F.error(((d=a.responseJSON)==null?void 0:d.message)||"Failed to load repair orders")}},columns:[{data:"order_number",title:"RO #"},{data:"created_at",title:"Date",render:function(a){return E(a)}},{data:"customer.name",title:"Customer"},{data:"device_type.name",title:"Device Type",render:function(a){return a||"N/A"}},{data:"device_brand",title:"Brand",render:function(a){return a||"N/A"}},{data:"device_model",title:"Device"},{data:"status",title:"Status"},{data:"technician.full_name",title:"Technician"},{data:"total_amount",title:"Total",className:"text-end fw-semibold",render:function(a){return s(a)}},{data:"expected_completion_date",title:"ETA",render:function(a){return a?E(a):"N/A"}},{data:"action",title:"Actions",orderable:!1,searchable:!1}],order:[[0,"desc"]],createdRow:function(a,d,y){$(a).find("td:not(:last-child)").css("cursor","pointer"),$(a).on("click",function(p){$(p.target).closest("button, a").length||(window.location=route("repair-orders.show",d.id))})},drawCallback:function(){$(".print-btn").off("click").on("click",function(){const a=$(this).data("data");S(a)})}})),[n,o]);h.useEffect(()=>{const t=f();return()=>{$.fn.DataTable.isDataTable("#repairOrdersTable")&&t.destroy()}},[f,n,o]);const S=t=>{var v,T,w,_,D,N;const y=window.screen.width/2-450,p=window.screen.height/2-700/2,l=window.open("","Print Repair Invoice",`width=900,height=700,left=${y},top=${p},resizable=yes,scrollbars=yes`),O="/storage/images/logos/logo.png",A=new Date(t.created_at).toLocaleString(),P=((v=t==null?void 0:t.parts)==null?void 0:v.map((i,g)=>`
                    <tr>
                        <td>${g+1}</td>
                        <td>${i.part_name}</td>
                        <td>${i.part_number||"-"}</td>
            ...
            <html>
                ...
                <body>
                    ...
                    <table>
                        <tr>
                            <td>
                                <strong>Name:</strong> ${((w=t.customer)==null?void 0:w.name)||""}<br/>
