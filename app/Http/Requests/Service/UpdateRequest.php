...
class UpdateRequest extends FormRequest
{
    ...
    {
        $repairOrderId = $this->route('repair_order');

        return [
            // Customer information
            'customer.customer_id' => 'sometimes|integer|exists:users,id',
            'customer.customer_name' => 'sometimes|string|max:255',
            'customer.customer_phone' => 'sometimes|string|max:20',
            'customer.customer_email' => 'sometimes|email|max:255',
            ...
            // Job details
            'job_details.order_number' => 'sometimes|string|max:50|unique:repair_orders,order_number,' . $repairOrderId,
            ...
            'payment_info.mpesa.*.transId' => 'nullable|string|max:255',
    ...
    {
        return [
            'customer.customer_id.integer' => 'Customer ID must be an integer',
            ...
            'customer.customer_email.email' => 'Customer email must be valid',
            'job_details.order_number.unique' => 'This order number already exists',
            ...
            'job_details.warranty.in' => 'Warranty status must be either "in" or "out"',
            'job_details.priority.in' => 'Priority must be one of: low, medium, high, urgent, normal',
            'job_details.repair_service_id.exists' => 'Selected repair service does not exist',
        ];
    }
