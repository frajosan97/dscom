...
import { FaShoppingBag, FaHeart, FaAward, FaUsers, FaLeaf, FaRocket, FaPlay } from 'react-icons/fa';
...
export default function About() {
    ...
    const values = [
        { title: "Sustainability", icon: <FaLeaf />, description: "We're committed to eco-friendly practices and sustainable sourcing." },
        { title: "Innovation", icon: <FaRocket />, description: "Constantly evolving to bring you the latest trends and technologies." },
        { title: "Customer First", icon: <FaHeart />, description: "Your satisfaction is our top priority in every decision we make." }
    ];
            ...
            <Container fluid className="px-0 about-page">
                        ...
                        <Row className="align-items-center">
                            <Col lg={6}>
                                ...
                                <p className="lead mb-4">
                                    Founded in 2018, we started as a small team with a big dream - to revolutionize online shopping.
                                    Today, we're proud to serve thousands of customers worldwide with curated, high-quality products.
                                </p>
                                <Button variant="primary" as={Link} href="/" size="lg" className="rounded-pill px-4">
                                    Shop Now
                                </Button>
                            </Col>
                    ...
                    <Container>
                        <Row className="align-items-center">
                            <Col lg={6} className="mb-4 mb-lg-0">
                                ...
                                <p className="lead">
                                    To provide exceptional value through carefully curated products, outstanding customer service,
                                    and a seamless shopping experience that exceeds expectations.
                                </p>
                                <p>
                                    We believe in building lasting relationships with our customers by offering products that enhance
                                    their lives while maintaining the highest standards of quality and ethical business practices.
                                </p>
                            </Col>
                            <Col lg={6}>
                                <div className="mission-video rounded-4 overflow-hidden shadow">
                                    <div className="ratio ratio-16x9">
                                        ...
                                        <div className="d-flex align-items-center justify-content-center bg-primary bg-opacity-10">
                                            <Button variant="primary" size="lg" className="rounded-circle play-button">
                                                <FaPlay />
                                            </Button>
                                        </div>
                                    </div>
                ...
                <section className="team-section py-5">
                    <Container>
                        <div className="text-center mb-5">
                            ...
                            <p className="text-muted">The passionate people behind your shopping experience</p>
                        </div>
                        <Row className="g-4">
                                    ...
                                    <Card className="team-card border-0 shadow-sm h-100 overflow-hidden">
                                        ...
                                        <Card.Body className="text-center py-4">
                                            ...
                                            <div className="social-links">
                                                <Button variant="link" className="text-dark"><FiTwitter /></Button>
                                                <Button variant="link" className="text-dark"><FiLinkedin /></Button>
                                                <Button variant="link" className="text-dark"><FiInstagram /></Button>
                                            </div>
                                        </Card.Body>
                                    </Card>
                                </Col>
                ...
                <section className="cta-section py-5 bg-primary text-white">
                    <Container className="text-center">
                        ...
                        <p className="lead mb-4">Join thousands of satisfied customers shopping with us today.</p>
