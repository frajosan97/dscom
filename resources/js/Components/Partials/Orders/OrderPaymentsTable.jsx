        ...
        <Table striped bordered hover className="mt-3">
            ...
            <tbody>
                {payments.map((payment, index) => (
                    <tr key={index}>
                        <td>{format(new Date(payment.created_at), 'MMM dd, yyyy')}</td>
            ...
            <tfoot>
                <tr>
                    <td colSpan={3} className="text-end fw-semibold">Total Paid</td>
                    <td className="text-end fw-semibold">
                        {currency} {payments.reduce((sum, payment) => sum + payment.amount, 0)}
                    </td>
                    <td></td>
                </tr>
            </tfoot>
