            ...
            <Col md={6}>
                <FloatingLabel controlId="comparePrice" label="Compare Price">
                    <Form.Control
                        ...
                        onChange={(e) =>
                            setData("compare_price", parseFloat(e.target.value))
                        }
            ...
            <Col md={6}>
                <FloatingLabel controlId="agentPrice" label="Agent Price">
                    <Form.Control
                        ...
                        onChange={(e) =>
                            setData("agent_price", parseFloat(e.target.value))
                        }
            ...
            <Col md={6}>
                <FloatingLabel controlId="costPerItem" label="Cost Per Item">
                    <Form.Control
                        ...
                        onChange={(e) =>
                            setData("cost_per_item", parseFloat(e.target.value))
                        }
